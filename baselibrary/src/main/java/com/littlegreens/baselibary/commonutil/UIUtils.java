...
// ios  标准
    public static final float STANDARD_WIDTH=375f;
    public static final float STANDARD_HEIGHT=667f;
...
//        计算缩放系数
        ...
        if(displayMetricsWidth==0.0f || displayMetricsHeight==0.0f){
            ...
            density = displayMetrics.density; // 屏幕密度（0.75 / 1.0 / 1.5）
            densityDpi = displayMetrics.densityDpi; // 屏幕密度DPI（120 / 160 / 240）
             systemBarHeight=getSystemBarHeight(context);
            Log.e("screen","widthPixels:"+displayMetrics.widthPixels+" heightPixels:"+displayMetrics.heightPixels);
            //横屏
